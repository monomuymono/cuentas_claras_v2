...
// La importación de createPortal ya no es necesaria
...
const App = () => {
  ...
  const handlePrint = () => {
    ...
    // Incluir Tailwind CSS desde CDN para aplicar estilos en la nueva ventana
    ...
    // Dar tiempo a que carguen los estilos de Tailwind antes de imprimir
    setTimeout(() => {
        printWindow.focus();
        printWindow.print();
        printWindow.close();
  ...
  return (
    <div>
      ...
      {/* Contenedor oculto que sirve como fuente para la impresión */}
